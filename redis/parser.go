...
func parseRequestBase(conn io.ReadCloser,r *bufio.Reader) (*Request,error) {
...
func ParseRequest(conn io.ReadCloser,r *bufio.Reader) (*Request, error) {
	return parseRequestBase(conn,r);
}
